...
function addCandy(candyStore, id, name, price) {
  candyStore.candies.push({ amount: 1, name, id, price });
}
...
function buy(candyStore, id) {
  ...
  if (candy.amount) {
    ...
    return candyStore.cashRegister;
  }
  return -1;
}
...
addCandy(candyStore, '12pG', 'Bubblegum', 2.5);
buy(candyStore, '12pG');
console.log(getCandy(candyStore, '12pG'));
